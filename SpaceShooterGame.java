...
public class SpaceShooterGame extends JComponent implements KeyListener, MouseListener, MouseMotionListener
{
    ...
    {   
        ...
        if (titleState == gameState) { 
            ...
            Graphics2D g2d;
            g2d = (Graphics2D)g; 
            ImageIcon background = new ImageIcon(LearningGraphics.class.getResource("6505830.png")); 
            ...
            Graphics2D g2d1;
            g2d1 = (Graphics2D)g; 
            ImageIcon spaceship = new ImageIcon(LearningGraphics.class.getResource("Unknown.png")); 
        ...
        //drawings for the main game
            ...
            Graphics2D g2d;
            g2d = (Graphics2D)g; 
            ImageIcon background = new ImageIcon(LearningGraphics.class.getResource("aRTU1s.png")); 
            g2d.drawImage(background.getImage(), 0, 0, WIDTH, HEIGHT, null);
